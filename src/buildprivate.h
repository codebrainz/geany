/*
 *      buildprivate.h - this file is part of Geany, a fast and lightweight IDE
 *
...
/* build stuff that is not part of the plugin API. */

#ifndef GEANY_BUILD_PRIVATE_H
#define GEANY_BUILD_PRIVATE_H 1
